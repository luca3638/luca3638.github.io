...
const music = new Audio("../assets/sounds/music2.mp3");
      music.loop = true;
      music.volume = 0.5;
...
let gameState = "menu"; // menu, action, gameover or finish
...
// frog variables
const frogImage = new Image(150, 150);
      frogImage.src = "../assets/images/frog.png";
const frogXSpeed = -20.5;
const froghitboxradius= 25;
const frogSpawnInterval = 500;
let frogTimeSinceLastSpawn = frogSpawnInterval;
let frogs = [];
